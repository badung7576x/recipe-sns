          ...
          <form style="font-size: large; margin-left: 15rem" action="{{ route('recipe.store') }}" method="post" enctype="multipart/form-data">
            ...
            <table class="create-recipe">
              ...
              <tr>
                ...
                <td>
                  <input type="number" min="0" name="cooking_time" class="create-recipe-input" value="{{ old('cooking_time', '') }}" />
                  @error('cooking_time')
                    <p class="error-msg" role="alert">
                      {{ $message }}
                    </p>
            ...
            <table class="create-recipe">
              ...
              @for ($i = 0; $i < 10; $i++)
                <tr>
                  ...
                  <td>
                    <input type="number" min="0"  name="material_quantity[]" class="ml-10" value="{{ old('material_quantity.' . $i) }}" />
